...
## Stage 8: Homepage Dashboard — COMPLETE (implemented 2026-04-16, auth added 2026-04-19)
...
## Stage 10b: Pocket ID — NetBird passkey IdP — COMPLETE (2026-04-20)

Replaced embedded Dex (built into `netbirdio/management`) with Pocket ID, a
passkey-only OIDC provider co-located on the VPS. Eliminates password-based
NetBird login; all authentication via FIDO2/WebAuthn passkeys.
